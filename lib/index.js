...
/* harmony import */ var C_Users_Admin_Desktop_git_lowcode_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(102);
/* harmony import */ var C_Users_Admin_Desktop_git_lowcode_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(243);
/* harmony import */ var C_Users_Admin_Desktop_git_lowcode_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(104);
/* harmony import */ var _BaseRenderTable_index__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(164);
/* harmony import */ var _BaseRenderForm_index__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(52);
/* harmony import */ var _BaseRenderRegular_index__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(168);
/* harmony import */ var _component_importFile_vue__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(249);
/* harmony import */ var _baseConfig_tableSelectConfigs__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(258);
/* harmony import */ var _baseConfig_widgetBaseConfig__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(162);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(105);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'completeTable',
  components: {
    BaseRenderTable: _BaseRenderTable_index__WEBPACK_IMPORTED_MODULE_29__["default"],
    BaseRenderForm: _BaseRenderForm_index__WEBPACK_IMPORTED_MODULE_30__["default"],
    BaseRenderRegular: _BaseRenderRegular_index__WEBPACK_IMPORTED_MODULE_31__["default"],
    importFile: _component_importFile_vue__WEBPACK_IMPORTED_MODULE_32__["default"]
  },
  props: {
    requestTableData: {
      type: Function
  ...
  methods: {
    ...
    onSubmit: function onSubmit(data) {
      var _this = this;
      return (0,C_Users_Admin_Desktop_git_lowcode_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_28__["default"])( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
    ...
    init: function init() {
      var _this2 = this;
      return (0,C_Users_Admin_Desktop_git_lowcode_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_28__["default"])( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
    ...
    composeData: function composeData(emptyData) {
      ...
      this.tableOptions = this.tableConfigJSON.filter(function (item) {
        ...
        obj.align = _baseConfig_tableSelectConfigs__WEBPACK_IMPORTED_MODULE_33__.align.find(function (alignitem) {
    ...
    composeFromOptions: function composeFromOptions(tableData) {
      ...
      tableData.map(function (item, index) {
        var _searchWidget$find;
        var searchWidgetName = (_searchWidget$find = _baseConfig_tableSelectConfigs__WEBPACK_IMPORTED_MODULE_33__.searchWidget.find(function (widgetitem) {
          return widgetitem.id === item.searchWidget;
        })) === null || _searchWidget$find === void 0 ? void 0 : _searchWidget$find.tagName;
        // 只有搜索控件有值，才会添加到options中
        if (searchWidgetName) {
          ...
          var options = (0,_utils__WEBPACK_IMPORTED_MODULE_35__.getWidgetOptions)(searchWidgetName, item);
        ...
        if (length - 1 === index && formOptions.length) {
          ...
          // 添加筛选和重置按钮
          formOptions.push.apply(formOptions, (0,C_Users_Admin_Desktop_git_lowcode_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_27__["default"])(_this4.getBtnConfig()));
    ...
    getBtnConfig: function getBtnConfig() {
      var filterConfig = (0,_baseConfig_widgetBaseConfig__WEBPACK_IMPORTED_MODULE_34__.getElBtnConfig)('primary', this.handleFilter, '筛选');
      var resetConfig = (0,_baseConfig_widgetBaseConfig__WEBPACK_IMPORTED_MODULE_34__.getElBtnConfig)('', this.handleReset, '重置');
      (0,_utils__WEBPACK_IMPORTED_MODULE_35__.setColSpan)(filterConfig, 2);
      (0,_utils__WEBPACK_IMPORTED_MODULE_35__.setColSpan)(resetConfig, 2);
    ...
    queryTableData: function queryTableData() {
      var _this5 = this;
      var params = (0,C_Users_Admin_Desktop_git_lowcode_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_26__["default"])((0,C_Users_Admin_Desktop_git_lowcode_node_modules_babel_runtime_helpers_esm_objectSpread2__WEBPACK_IMPORTED_MODULE_26__["default"])({}, this.searchFrom), this.page);
      return (this.showPagination ? this.requestTablePaginationData(params) : this.requestTableData(this.searchFrom)).then(function (res) {
        if (res.result === '0') {
    ...
    exec: _utils__WEBPACK_IMPORTED_MODULE_35__.exec,
