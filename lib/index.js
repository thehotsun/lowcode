...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
      ...
      return this.requestTableConfig().then(function (res) {
        if (res.result === '0') {
          var _JSON$parse = JSON.parse(res.data),
            ...
            _JSON$parse$formOptio = _JSON$parse.formOptions,
            _JSON$parse$formOptio2 = _JSON$parse$formOptio.FcDesignerRule,
            FcDesignerRule = _JSON$parse$formOptio2 === void 0 ? [] : _JSON$parse$formOptio2,
            _JSON$parse$formOptio3 = _JSON$parse$formOptio.FcDesignerOptions,
            FcDesignerOptions = _JSON$parse$formOptio3 === void 0 ? {} : _JSON$parse$formOptio3;
          _this4.tableConfigJSON = tableOptions;
          _this4.rule = FcDesignerRule;
          _this4.option = FcDesignerOptions;
        } else {
    ...
    onFromSubmit: function onFromSubmit() {} // queryBtnConfig () {
...
/* harmony import */ var _index_vue_vue_type_style_index_0_id_6d5410d8_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(214);
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(205);
  ...
  return _c("el-container", [_c("el-header", [_c("div", {
    ...
    on: {
      click: function click($event) {
        ...
        return _vm.handleOpenFormDesign();
      }
    }
  }, [_vm._v("\n          新增功能按钮\n        ")]), _vm._v(" "), _vm._t("btn")], 2)]), _vm._v(" "), _c("el-main", [_c("el-container", {
    staticStyle: {
      height: "100%"
    }
    ...
    on: {
      "update:visible": function updateVisible($event) {
        _vm.designerDialog = $event;
      }
    }
  }, [_c("fc-designer", {
    ref: "fcdesigner",
    on: {
      saveData: _vm.onFromDesignSave
    }
  })], 1)], 1);
};
var staticRenderFns = [];
...
/* harmony import */ var core_js_modules_es_json_stringify_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(212);
...
/* harmony import */ var _baseConfig_tableBaseConfig__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(213);
/* harmony import */ var _baseConfig_tableSelectConfigs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(202);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    handleOpenFormDesign: function handleOpenFormDesign() {
    ...
    // 打开设计器
    setDesigner: function setDesigner() {
    ...
    onFromDesignSave: function onFromDesignSave(FcDesignerRule, FcDesignerOptions) {
      this.formDesignData = {
        FcDesignerRule: FcDesignerRule,
        FcDesignerOptions: FcDesignerOptions
      };
      this.handleClose();
    }
  }
