  ...
  methods: {
    ...
    composeData: function composeData(emptyData) {
      ...
      this.tableOptions = this.tableConfigJSON.filter(function (item) {
        ...
        emptyData && _this2.setEmptyTableData(emptyData, item.fieldCode);
    ...
    composeFromOptions: function composeFromOptions(tableData) {
      ...
      tableData.map(function (item, index) {
        ...
        // 只有搜索控件有值，才会添加到options中
        if (searchWidgetName) {
          setFromField(_this3.searchFrom, item.fieldCode);
        ...
        if (length - 1 === index && formOptions.length) {
          _this3.rawSearchFrom = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_1___default()(_this3.searchFrom);
          // 添加筛选和重置按钮
          formOptions.push.apply(formOptions, (0,C_Users_Admin_Desktop_git_lowcode_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_24__["default"])(_this3.getBtnConfig()));
          _this3.showSearchFrom = true;
        }
      });
      return [{
        elRowAttrs: {
    ...
    queryTableConfig: function queryTableConfig() {
      ...
      return this.requestTableConfig().then(function (res) {
        if (res.result === '0') {
          ...
          _this5.tableConfigJSON = tableOptions;
          _this5.btnRegularOptions = _this5.composeBtnRegularOptions(formOptions);
        } else {
