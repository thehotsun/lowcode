...
/* harmony import */ var core_js_modules_es_array_find_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(199);
...
/* harmony import */ var core_js_modules_es_number_constructor_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(200);
/* harmony import */ var core_js_modules_es_number_constructor_js__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_es_number_constructor_js__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var C_Users_Admin_Desktop_git_lowcode_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(204);
/* harmony import */ var _baseConfig_widgetBaseConfig__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(210);
/* harmony import */ var _baseConfig_tableSelectConfigs__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(211);
...
function getWidgetOptions(searchWidgetName, item) {
  switch (searchWidgetName) {
    case 'el-input':
      return completeFromItemOptions((0,_baseConfig_widgetBaseConfig__WEBPACK_IMPORTED_MODULE_14__.getElInputConfig)(), item);
    case 'el-input-number':
      return completeFromItemOptions((0,_baseConfig_widgetBaseConfig__WEBPACK_IMPORTED_MODULE_14__.getElInputNumberConfig)(), item);
    case 'el-select':
      return completeFromItemOptions((0,_baseConfig_widgetBaseConfig__WEBPACK_IMPORTED_MODULE_14__.getElSelectConfig)(), item);
    case 'el-date-picker':
      return completeFromItemOptions((0,_baseConfig_widgetBaseConfig__WEBPACK_IMPORTED_MODULE_14__.getElDatePickerConfig)(), item);
    case 'el-date-picker-range':
      return completeFromItemOptions((0,_baseConfig_widgetBaseConfig__WEBPACK_IMPORTED_MODULE_14__.getElDatePickerRangeConfig)(), item);
    case 'el-cascader':
      return completeFromItemOptions((0,_baseConfig_widgetBaseConfig__WEBPACK_IMPORTED_MODULE_14__.getElCascaderConfig)(), item);
    case 'dictionary':
      return completeFromItemOptions((0,_baseConfig_widgetBaseConfig__WEBPACK_IMPORTED_MODULE_14__.getElSelectConfig)(), item);
    default:
...
function getSetupFormOptions(searchWidgetName) {
  ...
  var complexOptions = function complexOptions() {
    ...
    }], ['标签名：', '请输入标签名', 'formItemAttrs.label', {
      style: 'width: 350px'
  ...
  switch (searchWidgetName) {
    case 'el-input':
      options = [getSetupFromSingleConfig('控件类型：', '请选择控件类型', '', {
        style: 'width: 350px',
        slotName: 'searchWidget'
      }), getSetupFromSingleConfig('标签名：', '请输入标签名', 'formItemAttrs.label', {
        style: 'width: 350px'
    ...
    case 'el-select':
      options = complexOptions().map(function (item) {
        return getSetupFromSingleConfig.apply(void 0, (0,C_Users_Admin_Desktop_git_lowcode_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_13__["default"])(item));
      });
      break;
    case 'el-cascader':
      options = complexOptions().map(function (item) {
    ...
    case 'dictionary':
      options = [getSetupFromSingleConfig('控件类型：', '请选择控件类型', '', {
        ...
        style: 'width: 350px',
        slotName: 'selectDic'
      }), getSetupFromSingleConfig('数据格式：', '请输入数据格式', 'extraOption', {
        style: 'width: 350px',
        extraOption: {
          options: [{
...
function getSetupForm(searchWidgetName) {
  ...
  form.searchWidgetType = (_searchWidget$find = _baseConfig_tableSelectConfigs__WEBPACK_IMPORTED_MODULE_15__.searchWidget.find(function (item) {
    return item.tagName === searchWidgetName;
  })) === null || _searchWidget$find === void 0 ? void 0 : _searchWidget$find.id;
  return form;
}
...
/* harmony export */ });
/* harmony import */ var _arrayWithoutHoles_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(205);
/* harmony import */ var _iterableToArray_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(207);
/* harmony import */ var _unsupportedIterableToArray_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(208);
/* harmony import */ var _nonIterableSpread_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(209);
...
/* harmony export */ });
/* harmony import */ var _arrayLikeToArray_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(206);
