<template>
  <div>
    <base-render-form ref="form" :formData="formData" :formOptions="formOptions" :onlyShow="false" @onClose="onClose"
      ...
      <template #operator="{ formData }">
        ...
        <customCompVue :formData="formData" @changeFormData="changeFormData"></customCompVue>
      </template>
      <!-- 
