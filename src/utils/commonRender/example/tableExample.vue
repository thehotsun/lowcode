<template>
  <el-container>
    <el-header>
      <base-render-form ref="form" :formData="searchFrom" :formOptions="formOptions" :useDialog="false">
      </base-render-form>
    ...
    <el-main>
      <el-container style="height: 100%">
        <el-main>
          <base-render-table ref="table" :tableData="tableData" :tableOptions="tableOptions" editMode
