  ...
  >
    <div style="min-width: 60px;background: #fff;padding: 10px;">
      <el-form ref="ruleForm" :model="tableAttrs" :rules="rules" label-width="150px" style="padding-bottom: 20px">
        ...
        <el-form-item label="onResetSearch">
          <el-tooltip
            slot="label"
            class="item"
            effect="dark"
            content="点击右上角重置筛选按钮触发的js脚本，如不填则执行默认行为（清空搜索数据并重新请求表格）"
            placement="top-start"
          >
            <span style="cursor: pointer;font-size: 14px">onResetSearch</span><i style="width: 20px; font-size: 14px;" class="el-icon-question"></i>
          </el-tooltip>
